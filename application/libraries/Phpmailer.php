...
//            $result .= static::$LE;
    ...
    public function sender($data_array) {

        /**
         * Method - отправитель письма из любого контроллера
         * @param $data_array - array(email, subject, body)
         */

        $this->isSMTP();
        $this->Host = 'smtp.gmail.com';
        $this->SMTPAuth = true;
        $this->Username = 'tester.cars1'; // Логин в google. Именно логин, без @gmail.com
...
//            $this->phpmailer->addAddress($email); // Еще один email, если нужно
        ...
        $this->CharSet = "utf-8";
        $this->isHTML(true);
        $this->Subject = $data_array['subject']; // Заголовок письма
        $this->Body = $data_array['body']; // Текст письма
